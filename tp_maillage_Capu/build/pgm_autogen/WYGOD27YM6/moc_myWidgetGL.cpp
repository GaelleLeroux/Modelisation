...
#include <memory>
#include "../../../src/local/interface/myWidgetGL.hpp"
...
QT_INIT_METAOBJECT const QMetaObject myWidgetGL::staticMetaObject = { {
    QMetaObject::SuperData::link<QGLWidget::staticMetaObject>(),
    qt_meta_stringdata_myWidgetGL.data,
    qt_meta_data_myWidgetGL,
    qt_static_metacall,
    nullptr,
    nullptr
} };
